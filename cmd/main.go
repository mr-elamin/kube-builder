...
import (
	...
	platformcontroller "github.com/mr-elamin/kubebuilder-practice/internal/controller/platform"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2f91f487.bssconnects.io",
	...
	if err := (&platformcontroller.ModuleInstanceReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "platform-moduleinstance")
		os.Exit(1)
	}
