...
type ModuleInstanceSpec struct {
	...
	// foo is an example field of ModuleInstance. Edit moduleinstance_types.go to remove/update
	// +optional
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &ModuleInstance{}, &ModuleInstanceList{})
		return nil
	})
}
